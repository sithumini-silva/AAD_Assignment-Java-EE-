...
<div class="welcome-banner animate__animated animate__fadeIn">
    <div class="welcome-text">
        ...
        <div class="quick-actions">
            <button class="quick-action-btn" onclick="location.href='complaint.jsp'">
                <i class="fas fa-plus"></i> Quick Complaint
            </button>
...
<div class="dashboard">
    ...
    <div class="card animate__animated animate__fadeIn animate__delay-4s">
        ...
        <p>View statistics and trends about your complaint history and resolution times.</p>
